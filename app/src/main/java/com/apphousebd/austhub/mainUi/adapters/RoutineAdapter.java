...
import com.apphousebd.austhub.dataModel.routineDataModel.RoutineModel;
...
public class RoutineAdapter extends RecyclerView.Adapter<RoutineAdapter.RoutineHolder>{
    ...
    public RoutineHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.routine_list_item, parent, false);
    ...
    public void onBindViewHolder(RoutineHolder holder, int position) {
        ...
        holder.startingTime.setText(item.getTime());
        holder.courseNumber.setText(item.getCourseNumber());
        holder.courseName.setText(item.getCourseName());
        holder.roomNumber.setText(item.getRoomNumber());
        holder.courseTeacher.setText(item.getTeachersName());
    ...
    public class RoutineHolder extends RecyclerView.ViewHolder{
        ...
        public RoutineHolder(View itemView) {
            ...
            startingTime = (TextView)itemView.findViewById(R.id.routine_starting_time);
